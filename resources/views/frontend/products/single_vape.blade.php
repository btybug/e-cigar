    ...
    <div class="container container--vape">
        ...
        <div class="tab-content tab-content--features">
            ...
            <div class="tab-pane fade" id="media" role="tabpanel" aria-labelledby="media-tab">
                <div id="jssorVideos" class="media-slider" style="position:relative;margin:0 auto;top:0px;left:0px;width:980px;height:600px;overflow:hidden;visibility:hidden;">
                    <!-- Loading Screen -->
