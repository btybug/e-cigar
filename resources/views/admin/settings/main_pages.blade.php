            ...
            <div class="row">
                <div class="col-3">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link @if($p=='single_product')active @endif" href="?p=single_product">Single Product</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link @if($p=='single_post')active @endif" href="?p=single_post">Single Post</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link @if($p=='confirmation_page')active @endif" href="?p=confirmation_page">Confirmation Page</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="tab-pane fade active in show" id="admin_settings_general">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card panel panel-default social-profile-page mb-3">
                                    <div class="card-header panel-heading">Bottom {!! $p !!}</div>
                                    <div class="card-body panel-body">
                                        <div class="form-group d-flex flex-wrap align-items-center social-media-group">
