<div class="brands-right-content">
    <div class="brand-main-content-top">
        <div class="brand-main-content-top-inner">
            <div class="row">
                <div class="col-xl-6 image-title-outer">
                    <div class="image-title">
                        <img src="{!! url($brand->image) !!}" alt="logo">

                    </div>
                </div>
                <div class="col-xl-6">
                    <div class="info">
                        <h1 class="main-title font-40 font-main-bold text-uppercase">{!! $brand->name !!}</h1>
                        <div class="desc text-main-clr font-15">
                            <p>
                                {!! $brand->description !!}
                            </p>
                        </div>
