                                                ...
                                                <div class="product-content">
                                                    <div class="product-title-more d-flex flex-wrap justify-content-between align-items-center">
                                                        <div class="product-title">
                                                            <h5 class="font-25 font-sec-bold text-uppercase m-0">VAPES</h5>
                                                        </div>
...
<path fill-rule="evenodd"  fill="rgb(81, 132, 229)"
      d="M0.002,5.617 L16.071,5.617 L16.071,9.000 L21.996,4.500 L16.071,0.000 L16.071,3.383 L0.002,3.383 L0.002,5.617 Z"/>
                                                    ...
                                                    <div class="product-desc">
                                                        <p class="mb-0 font-main-light text-light-clr font-15">Suspendisse at ante ac arcu elementum interdum.
                                                            Nullam lorem elit, volutpat in maximus id, sodales
                                                            vulputate ante. Sed vehicula finibus ipsum.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-sm-6">
                                            <div class="single-product">
                                                ...
                                                <div class="product-content">
                                                    <div class="product-title-more d-flex flex-wrap justify-content-between align-items-center">
                                                        <div class="product-title">
                                                            <h5 class="font-25 font-sec-bold text-uppercase m-0">E-JUICE</h5>
                                                        </div>
                                                        <div class="product-more">
                                                            <div class="d-flex align-items-center">
                                                                <a href="{!! route('categories_front') !!}" class="text-tert-clr font-13">View more</a>
                                        ...
                                        <div class="col-md-3 col-sm-6">
                                            <div class="single-product">
                                                ...
                                                <div class="product-content">
                                                    <div class="product-title-more d-flex flex-wrap justify-content-between align-items-center">
                                                        <div class="product-title">
                                                            <h5 class="font-25 font-sec-bold text-uppercase m-0">PARTS</h5>
                                                        </div>
                                                        <div class="product-more">
                                                            <div class="d-flex align-items-center">
                                                                <a href="{!! route('categories_front') !!}" class="text-tert-clr font-13">View more</a>
                                        ...
                                        <div class="col-md-3 col-sm-6">
                                            <div class="single-product">
                                                ...
                                                <div class="product-content">
                                                    <div class="product-title-more d-flex flex-wrap justify-content-between align-items-center">
                                                        <div class="product-title">
                                                            <h5 class="font-25 font-sec-bold text-uppercase m-0">accessories</h5>
                                                        </div>
                                                        <div class="product-more">
                                                            <div class="d-flex align-items-center">
                                                                <a href="{!! route('categories_front') !!}" class="text-tert-clr font-13">View more</a>
