...
@section('content')
    <div class="coupons_new_page card panel panel-default">
        <div class="card-header panel-heading">
            <h3 class="m-0">Purchase View for {{ $group->item->name }}</h3>
        </div>
        <div class="card-body panel-body">
            <div class="row d-flex flex-wrap">

            @foreach($models as $model)
                <div class="col-xl-4" style="border: 1px solid">
                    <div class="form-group row required">
                        <label class="col-sm-2 control-label" for="input-code">
                            <span data-toggle="tooltip" title="" data-original-title="">Created Date</span></label>
                        <div class="col-sm-10">
                            <div class="form-control">
                                {{ BBgetDateFormat($model->purchase_date) }}
                            </div>
                        </div>
                    </div>
