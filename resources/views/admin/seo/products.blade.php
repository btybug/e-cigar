                ...
                <div class="card panel panel-default">
                    ...
                    <div class="card-body panel-body">
                        <select name="table_head" id="table_head_id" multiple class="form-control">
                            ...
                            <option value="OG title" data-column="2" data-name="og:title">OG title</option>
                            <option value="OG image" data-column="3" data-name="og:image">OG image</option>
                            <option value="OG description" data-column="4" data-name="og:description">OG description</option>
                            <option value="OG Keywords" data-column="5" data-name="og:keywords">OG Keywords</option>
                            <option value="Robots" data-column="6" data-name="robots">Robots</option>
                            <option value="FB title" data-column="7" data-name="fb:title">FB title</option>
                            <option value="FB image" data-column="8" data-name="fb:image">FB image</option>
                            <option value="FB description" data-column="9" data-name="fb:description">FB description</option>
                            <option value="TW title" data-column="10" data-name="tw:title">TW title</option>
                            <option value="TW image" data-column="11" data-name="tw:image">TW image</option>
                            <option value="TW description" data-column="12" data-name="tw:description">TW description</option>
