...
@section('js')
    ...
    <script>
        $("body").on('click','.add-category',function () {
            AjaxCall("/admin/tools/categories/post/get-form", {id: null}, function (res) {
                if(! res.error){
        ...
        var data = {!! json_encode(\App\Models\CategoryPost::recursiveItems($categories),true) !!};
        ...
        $("#tree1").tree({
            ...
            onDragStop: function (e, node) {
                ...
                AjaxCall("/admin/tools/categories/post/update-parent", {id, parentId}, function (res) {
        ...
        $("#tree1").bind("tree.click", function (e) {
            AjaxCall("/admin/tools/categories/post/get-form", {id: e.node.id}, function (res) {
                if(! res.error){
                    $(".category-form-place").html(res.html);
                    $('.icon-picker').iconpicker();
                }
