...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <div class="card juice-poster juice-poster--type-2 mb-5">
                <div class="row no-gutters">
                    <div class="col-md-5">
                        <h3 class="card-title text-center mb-0 p-2 text-white">Kaliony Cloud</h3>
                        <div class="img-outer card-img-outer p-4">
                            <img class="card-img-top" src="http://core.bootydev.co.uk/public/media/drive/3f44266c7fa59df324ec315e97e8579c.jpg" alt="">
                        </div>
                    </div>
            ...
            <div class="card juice-poster juice-poster--type-3 mb-5">
                <div class="row no-gutters">
                    <div class="col-md-5">
                        <h3 class="card-title text-center mb-0 p-2 text-white">Kaliony Mix</h3>
                        <div class="img-outer card-img-outer p-4">
                            <img class="card-img-top" src="http://core.bootydev.co.uk/public/media/drive/dbeb80a1e5db49c639aea4138ec8caa7.png" alt="">
                        </div>
                    </div>
