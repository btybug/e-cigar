...
class ReportsController extends Controller
{
    ...
    public function getList(Request $request, ItemsDataTable $dataTable)
    {
        return $dataTable->render('admin.reports.list', compact([]));
    }
    ...
    public function postCallFind(Request $request, ItemsDataTable $dataTable)
    {
        ...
        $form = view("admin.reports.$key.form", $data)->render();
    ...
    public function postCustomersResults(Request $request)
    {
        ...
        $html = view("admin.reports.customers.results", compact(['customers']))->render();
        return response()->json(['error' => false, 'html' => $html]);
    }
