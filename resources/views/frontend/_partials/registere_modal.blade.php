            ...
            <div class="row no-gutters modal-content_inner">
                ...
                <div class="col-md-8 col-sm-10">
                    <div class="modal_right">
                        ...
                        <form method="POST" action="{{ route('register') }}" class="register-form mt-5"
                              id="register-form-1">
                            @csrf
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="companyName"
                                               class="text-gray-clr register-form_label">{!! __('company_name') !!}</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="companyNumber"
                                               class="text-gray-clr register-form_label">{!! __('company_number') !!}</label>
                            ...
                            <div class="row">
                                ...
                                <div class="row no-gutters form-checkes-outer d-flex justify-content-between">
                                    <div>
                                        <input class="form-check-input register-form_input-radio wholesaler_radio"
                                               type="radio"
                                               name="wholesaler" id="wholesaler1" value="0" checked>
                                        <label
                                            class="form-check-label mb-0 d-flex align-items-center text-gray-clr pointer"
                            ...
                            <div class="row d-none wholesaler-box">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="companyNumber" class="text-gray-clr register-form_label">Company
                                            Number</label>
                                        <input id="companyNumber" type="text"
                                               class="form-control register-form_input-text"
                                               name="company_number" value="{{ old('company_number') }}">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="firstName"
                                               class="text-gray-clr register-form_label">{!! __('first_name') !!} <sup
                                                class="font-8 text-danger"><i class="fas fa-star"></i></sup></label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="lastName"
                                               class="text-gray-clr register-form_label">{!! __('last_name') !!} <sup
                                                class="font-8 text-danger"><i class="fas fa-star"></i></sup></label>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="e-mail"
                                               class="text-gray-clr register-form_label">{!! __('e_mail_address') !!}
                                            <sup class="font-8 text-danger"><i class="fas fa-star"></i></sup></label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="phoneNumber"
                                               class="text-gray-clr register-form_label">{!! __('phone_number') !!}</label>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="password"
                                               class="text-gray-clr register-form_label">{!! __('password') !!} <sup
                                                class="font-8 text-danger"><i class="fas fa-star"></i></sup></label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="confirmPassword"
                                               class="text-gray-clr register-form_label">{!! __('confirm_password') !!}
                                            <sup class="font-8 text-danger"><i class="fas fa-star"></i></sup></label>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group mb-0">
                                        <label for="country"
                                               class="text-gray-clr register-form_label">{!! __('country') !!}</label>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-md-7 d-flex align-items-center">
                                    <div class="position-relative">
                                        ...
                                        <label class="form-check-label text-gray-clr register-form_label pointer"
                                               for="defaultCheck1">
                                            {!! __('reg_agree_to') !!}&nbsp;&nbsp; <a href="#"
                                                                                      class="text-uderlined text-gray-clr">{!! __('terms_and_conditions') !!}</a>
                                            <span
  ...
  <path
      d="m.3,14c-0.2-0.2-0.3-0.5-0.3-0.7s0.1-0.5 0.3-0.7l1.4-1.4c0.4-0.4 1-0.4 1.4,0l.1,.1 5.5,5.9c0.2,0.2 0.5,0.2 0.7,0l13.4-13.9h0.1v-8.88178e-16c0.4-0.4 1-0.4 1.4,0l1.4,1.4c0.4,0.4 0.4,1 0,1.4l0,0-16,16.6c-0.2,0.2-0.4,0.3-0.7,0.3-0.3,0-0.5-0.1-0.7-0.3l-7.8-8.4-.2-.3z"/>
                                ...
                                <div class="col-md-5 text-right modal-accounts_btn-holder">
                                    <button type="submit"
                                            class="btn text-uppercase btn-submit font-15">{!! __('sign_up') !!}</button>
                                </div>
                            </div>
                            <div class="row">
