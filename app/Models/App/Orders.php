...
class Orders extends Model
{
    ...
    protected $fillable = ['shop_id', 'status', 'user_id', 'discount', 'order_number',  'staff_id', 'payment_method','additional_data','tendered', 'changed', 'sub_total', 'total', 'tax','admin_discount'];
