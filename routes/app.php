...
Route::group(['prefix' => 'discounts'], function () {
    Route::get('/{id}', 'AppController@discounts')->name('app_customer_discounts');
    Route::get('/create/{w_id}', 'Customers\DiscountController@create')->name('app_customer_discounts_create');
    Route::get('/edit/{id}/{w_id}', 'Customers\DiscountController@edit')->name('app_customer_discounts_edit');
    Route::post('/create/{w_id}', 'Customers\DiscountController@postCreate')->name('app_customer_discounts_create_post');
    Route::post('/edit/{id}', 'Customers\DiscountController@postEdit')->name('app_customer_discounts_edit_post');

    Route::get('/offers/{id}', 'AppController@offers')->name('app_customer_offers');
    Route::get('/offers/create/{w_id}', 'Customers\DiscountController@offersCreate')->name('app_customer_offers_create');
    Route::get('/offers/edit/{id}/{w_id}', 'Customers\DiscountController@offersEdit')->name('app_customer_offers_edit');
    Route::post('/offers/create/{w_id}', 'Customers\DiscountController@postOffersCreate')->name('app_customer_offers_create_post');
    Route::post('/offers/edit/{id}/{w_id}', 'Customers\DiscountController@postOffersEdit')->name('app_customer_offers_edit_post');
