                    ...
                    <div class="tab-content">
                        <div class=" active tab-pane" id="profile">
                          ...
                          Please enter your last name.</span>
                                ...
                                <div class="form-group">
                                    <label for="inputSkills" class="col-sm-2 control-label">Picture
                                    </label>
                       ...
                       Please upload small size image.</span>
                          ...
                          Please enter your address.</span>
                                ...
                                <div class="form-group">
                                    <label for="inputExperience" class="col-sm-2 control-label">City
                                    </label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control" name="country" id="entry_country_id">
                                            ...
                                            <option selected="" value="56">Czech Republic</option>
                                ...
                                <div class="form-group">
                                    <label for="inputExperience" class="col-sm-2 control-label">Zip Code</label>

                                    <div class="col-sm-10">
                                        <input class="form-control" id="zip" name="zip" type="text" value="38000">
                                    </div>
                                </div>
                                <div class="form-group">
