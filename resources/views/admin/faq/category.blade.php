    ...
    <div class="container-fluid">
        <div class="d-flex flex-wrap justify-content-between w-100 admin-general--tabs-wrapper">
            <ul class="nav nav-tabs new-main-admin--tabs mb-3 admin-general--tabs" id="myTab" role="tablist">
                @ok('admin_faq_settings')
                    <li class="nav-item ">
                        <a class="nav-link " id="general-tab" href="{!! route('admin_faq_settings') !!}" role="tab"
                ...
                @ok('admin_faq_setting_category')
                    <li class="nav-item ">
                        <a class="nav-link active" id="invoice-tab" href="{!! route('admin_faq_setting_category') !!}" role="tab"
        ...
        <div class="tab-content">
            <div class="card-header panel-heading head-space-between">
                <h2>{!! ucfirst(str_replace("_"," ",'faq')) !!} Category</h2>
...
@section('js')
    ...
    <script>
        ...
        $("body").on('click', '.add-category', function () {
            AjaxCall("/admin/tools/categories/get-form/faq", {id: null}, function (res) {
                if (!res.error) {
        ...
        $("#tree1").bind("tree.click", function (e) {
            AjaxCall("/admin/tools/categories/get-form/faq", {id: e.node.id}, function (res) {
                if (!res.error) {
                    $(".category-form-place").html(res.html);
                    $('.icon-picker').iconpicker();
                    $("#select-stickers").select2();
