                        ...
                        <div class="left-content">
                            ...
                            <div class="title-cat d-flex justify-content-between align-items-center">
                                ...
                                <div class="cat-time text-right">
                                    ...
                                    <div class="font-13 text-light-clr">Category name</div>
                                </div>
                            </div>
                                ...
                                <div class="admin d-flex mb-1">
                                    ...
                                    <div class="admin-main ">
                                        ...
                                        <div class="admin-desc">
                                            <p class="mb-0 font-main-light font-13 text-light-clr">{{ $post->short_descriptiom }}</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="tags mb-1">
                                    <ul class="list-inline m-0 p-0">
                                        <li class="list-inline-item"><a href="#" class="text-light-clr">Tag name
                                                1</a></li>
                                        <li class="list-inline-item"><a href="#" class="text-light-clr">Tag name
                                                2</a></li>
                                        <li class="list-inline-item"><a href="#" class="text-light-clr">Tag name
                            ...
                            <div class="news-main-content font-main-light font-15">
                                ...
                                @if($post->gallery && count($post->gallery))
                                    <div class="content-images d-flex flex-wrap">
                                    @foreach($post->gallery as $gal)
                                        <div class="col-sm-4 pl-sm-0 mb-sm-0 mb-2">
                                            <img src="{{ $gal }}" alt="">
                                        </div>
                                    @endforeach
                                    </div>
                                ...
                                <p class="mb-22">Enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea
                                    commodo consequat. Duis aute irure dolor
                                    in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.
                                    Excepteur sint occaecat cupidatat non proident, sunt
                                    in culpa qui officia deserunt mollit anim id est laborum.</p>
                                <p class="mb-0">Sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id
