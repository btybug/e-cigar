                        ...
                        <div class="tab-content tab-content-store-settings">
                            <div class="tab-pane active in show" id="general" role="tabpanel"
                                ...
                                <div class="row">
                                            ...
                                            <div class="col-lg-4 mb-1">
                                                <div class="card panel panel-default">
                                                    <div class="card-header panel-heading">
                                                        <h3 class="panel-title h6"><i class="fa fa-shopping-cart"></i> Order
                                                            Details</h3>
                                                    </div>
                                                    <table class="table">
                                                        <tbody>
                                    ...
                                    <div class="col-md-3">
                                        <div class="card panel panel-default panel--orders-addresses customer-notes mb-1">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <ul class="nav nav-pills flex-column nav-stacked">
                                                <li class="nav-item"><a class="nav-link" href="#invoice-doc" data-toggle="tab">Invoice</a></li>
                                                <li class="nav-item"><a class="nav-link active" href="#shipping-doc" data-toggle="tab">Shipping label</a>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="col-md-9">
                                        ...
                                        <div class="hidden-add-field" id="addStatusField">
                                            ...
                                            <div class="hidden-add-field_body">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-sm-4 control-label col-form-label" for="changeStatusSelect">Change
                                                        status to</label>
                                                    <div class="col-sm-8">
