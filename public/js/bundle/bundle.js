                ...
                $.ajax({
                    ...
                    error: function error(_error5) {
                        ...
                        if (wholesaler_radio.val()) {
                            ...
                            errorHandler(companyName, _error5.responseJSON.errors, _error5.responseJSON.errors.company_name, '#companyName');
                            errorHandler(companyNumber, _error5.responseJSON.errors, _error5.responseJSON.errors.company_number, '#companyNumber');
                        }
                    }
                });
            });
