                                    ...
                                    <div class="product-single-info-outer">
                                        <div class="product-single-info">
                                            <div class="d-flex align-items-center single-product-main-title">
                                                <!--like icon-->
                                                @if(Auth::check())
                                                    <span data-id="" class="add-fav-variation product-card_like-icon like-icon d-inline-flex align-items-center justify-content-center rounded-circle pointer d-none" > <!--gets class active-->
                                                        <svg viewBox="0 0 20 18" width="20px" height="18px">
                                                ...
                                                <div class="col-md-3 products-wrap_col">
                                                    <div class="product-card position-relative">
                                                        <div class="product-card_view position-relative">
                                                            <!--product main image-->
                                                            <div>
                                                                <img class="card-img-top" src="{{$related_product->image}}"
                                                                     alt="">
                                                            </div>
                                                            <!--like icon-->
                                                        ...
                                                        <div class="product-card_body">
                                                            ...
                                                            <div class="d-flex product-card-thumbs">
                                                                <div class="product-card_thumb-img-holder pointer active_slider">
                                                                    <img class="" src="{{$related_product->image}}" alt=""
                                                                         data-img="1">
                                                                </div>
                                                            ...
                                                            <a href="javascript:void(0)" data-id="{{ $related_product->variations->first()->id }}" class="product-card_btn d-inline-flex align-items-center text-center font-15 text-white text-sec-clr text-uppercase __add_to_card">
                                                                ...
                                                                <span class="d-inline-block ml-auto">
                                                                    <svg viewBox="0 0 18 22" width="18px" height="22px">
                                                                        <path fill-rule="evenodd" opacity="0.8" fill="rgb(255, 255, 255)" d="M14.305,3.679 L14.305,0.003 L3.694,0.003 L3.694,3.679 L-0.004,3.679 L-0.004,21.998 L18.003,21.998 L18.003,3.679 L14.305,3.679 ZM4.935,1.216 L13.064,1.216 L13.064,3.679 L4.935,3.679 L4.935,1.216 ZM16.761,20.785 L1.238,20.785 L1.238,4.891 L3.694,4.891 L3.694,7.329 L4.935,7.329 L4.935,4.891 L13.064,4.891 L13.064,7.329 L14.305,7.329 L14.305,4.891 L16.761,4.891 L16.761,20.785 Z"/>
                                                                    </svg>
                                                                </span>
                                                            </a>
                                                        </div>
