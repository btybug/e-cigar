                                ...
                                <tr>
                                    ...
                                    <td class="info-td">
                                        <div class="product-info-col">
                                            ...
                                            <div class="font-sec-reg font-26 text-main-clr lh-1 sec-title">Cola Shades
                                                E-Juice
                                            </div>
...
<path fill-rule="evenodd" stroke-width="2px" stroke="rgb(53, 53, 53)" opacity="0.702" fill="rgb(255, 255, 255)"
      d="M21.852,2.990 C19.636,2.990 17.428,4.080 15.999,5.846 C14.571,4.080 12.363,2.990 10.147,2.990 C6.125,2.990 3.001,6.258 3.001,10.466 C3.001,15.639 7.419,19.857 14.178,26.113 L15.999,28.011 L17.821,26.113 C24.580,19.857 28.998,15.639 28.998,10.466 C28.998,6.258 25.875,2.990 21.852,2.990 L21.852,2.990 Z"/>
                                                ...
                                                <a href="#" class="text-tert-clr font-18 lh-1 edit-link">Edit</a>
                                            </div>
                                        </div>
                                    </td>
                                            ...
                                            <ul class="list-unstyled mb-0">
                                                <li class="single-row-product">
                                                    <div class="d-flex flex-column w-100 col-9 p-0">
                                                        <div class="w-100">
                                                            <div class="row">
                                                                <div class="col-sm-8 font-15 font-main-bold">
                                                                    Mango Harmony Hit
                                                                </div>
                                                                <div
                                ...
                                <tr>
                                    <td colspan="5">
                                        <div class=" d-flex footer">
                                            <div class="add-offers font-26 font-sec-reg">Added <br/>Offers</div>
                                            <ul class="d-flex flex-wrap list-product">
                                                ...
                                                <li class="single-wall">
                                                    ...
                                                    <div class="info-product">
                                                        <h6 class="font-21 text-tert-clr title">Kangertech Vola 23 100W
                                                            Premium Vape copy 2</h6>
                                                        <div class="d-flex align-items-center price-wall">
                                ...
                                <tr>
                                    <td colspan="2" class="p-0">
                                        <div class="shp-cart-product d-flex flex-md-row flex-column">
                                            <div
                                                class="shp-cart-product_left d-flex flex-md-column justify-content-between mb-md-0 mb-3">
                                                    ...
                                                    @foreach($item->attributes->variations as $option)
                                                        <li class="shp-cart-product_row d-flex justify-content-between position-relative pr-0 py-2 border-bottom">
                                                            <div class="m-0 row w-100">
                                                                <div
                                                                    class="col-sm-3 pl-0  font-main-bold">{{ $option['group']->title }}
                                                                    :
                                                                </div>
                                                                            ...
                                                                            @if($option['group']->type == 'package_product' || $option['group']->type == 'filter')
                                                                                @if(count($option['options']))
                                                                                    @foreach($option['options'] as $voption)
                                                                                        <div class="row">
                                                                                            <div
                                                                                                class="col-sm-6 font-15 font-main-bold">
                                                                                                {{ $voption['option']->name }}
                                                                                            </div>
...
@endif
                                                                                            ...
                                                                                            @if($option['group']->price_per =='item')
                                                                                                <div
                                                                                                    class="col-sm-4 font-15 font-main-bold text-right">
                                                                                                    @php
                                                                        ...
                                                                        @if($option['group']->price_per =='product')
                                                                            <div
                                                                                class="font-15 font-main-bold align-self-center">
                                                ...
                                                <div class="shp-cart-extra-products mt-2">
                                                    <div class="row mb-2">
                                                        ...
                                                        <div class="col-md-6 text-right">
                                                            <button
                                                                data-product-id="{{ $item->attributes->product->id }}"
                                                                data-key="{{ $key }}"
                                                                class="btn btn-info extra-sections"><i
                                                    ...
                                                    <div class="extra-items" data-section="{{ $key }}">
                                                        @if($item->attributes->has('extra') && count($item->attributes->extra))
                                                            @foreach($item->attributes->extra as $extra)
                                                                <li class="shp-cart-product_row d-flex justify-content-between position-relative pr-0 py-2 border-bottom">
                                                                                 <span
                                                                                     class="pointer remove-extra-from-cart"
                                                                                     data-section-id="{{ $key }}"
                                                                                     data-uid="{{ $extra['key'] }}">
                                                                    ...
                                                                    <div class="m-0 row w-100">
                                                                        <div
                                                                            class="col-sm-3 pl-0  font-main-bold">{{ $extra['group']->title }}
                                                                            :
                                                                        </div>
                                                                                    ...
                                                                                    @if($extra['group']->type == 'package_product' || $extra['group']->type == 'filter')
                                                                                        @if(count($extra['options']))
                                                                                            @foreach($extra['options'] as $voption)
                                                                                                <div class="row">
                                                                                                    <div
                                                                                                        class="col-sm-6 pl-2 font-15 font-main-bold">
                                                                                                        {{ $voption['option']->name }}
                                                                                                    </div>
...
@endif
                                    ...
                                    <td width="180" class="text-center qty-cell-wrapper">
                                        <div class="simple_select_wrapper">
                                            <div class="continue-shp-wrapp_qty position-relative"
                                                ...
                                                <input data-uid="{{ $key }}"
                                                       class="qtycount field-input w-100 h-100 font-23 text-center border-0 product-qty-select none-touchable"
                                    ...
                                    <td width="180" class="shp-cart-table_price-td">
                                        <span
                                            class="d-flex justify-content-center font-main-bold font-28 card--inner-product_price position-relative">
