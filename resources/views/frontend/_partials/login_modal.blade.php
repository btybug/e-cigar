            ...
            <div class="row no-gutters modal-content_inner">
                ...
                <div class="col-md-8 col-sm-10">
                    <div class="modal_right d-flex flex-column justify-content-between h-100">
                        <div>
                            <h2 class="text-uppercase text-main-clr font-20 modal-title">{!! __('login') !!}</h2>
                        ...
                        <form  method="POST" action="{{ route('login') }}" class="register-form" id="login-form">
                            ...
                            <div class="form-group mb-5">
                                <label for="loginEmail" class="text-gray-clr register-form_label">{!! __('e_mail_address') !!}</label>
                            ...
                            <div class="form-group">
                                <label for="loginPass" class="text-gray-clr register-form_label">{!! __('password') !!}</label>
