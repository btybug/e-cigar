                    ...
                    <div class="product-content-left-col-inner">
                        <div class="d-flex w-100 product-tab-main-content-desc">
                            ...
                            <div class="share-btns d-inline-block ml-auto">
                               <a href="javascript:void(0)" class="d-block share-btns-item add-to-favorite" data-id="{!! $vape->id !!}">
                                   <svg width="32px" height="30px">
                                       <path fill-rule="evenodd" fill="rgb(34, 36, 35)"
                                             d="M31.814,8.946 C31.351,3.762 27.742,0.000 23.226,0.000 C20.217,0.000 17.462,1.647 15.912,4.285 C14.376,1.613 11.734,-0.000 8.774,-0.000 C4.258,-0.000 0.649,3.761 0.187,8.945 C0.150,9.174 -0.000,10.379 0.456,12.344 C1.114,15.179 2.634,17.757 4.850,19.799 L15.905,30.000 L27.150,19.800 C29.366,17.757 30.885,15.180 31.543,12.344 C32.000,10.380 31.850,9.175 31.814,8.946 ZM30.355,12.060 C29.755,14.649 28.363,17.008 26.333,18.877 L15.912,28.331 L5.670,18.879 C3.637,17.006 2.246,14.648 1.644,12.059 C1.212,10.200 1.390,9.149 1.391,9.142 L1.400,9.080 C1.796,4.538 4.897,1.241 8.774,1.241 C11.634,1.241 14.152,3.028 15.347,5.904 L15.909,7.259 L16.471,5.904 C17.647,3.072 20.298,1.242 23.226,1.242 C27.102,1.242 30.204,4.539 30.608,9.139 C30.610,9.149 30.787,10.200 30.355,12.060 Z"/>
                                   </svg>
                               </a>
                               <div class="d-block share-btns-item">
