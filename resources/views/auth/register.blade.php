            ...
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-md-6 registered-customers">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label class="col-md-4 col-form-label text-md-righ" for="gender">{{ __('Gender') }}</label>
                            <div class="col-md-6">
                                ...
                                <label class="radio-inline" for="female">
                                    <input type="radio" name="gender" id="female" class="{{ $errors->has('gender') ? ' is-invalid' : '' }}" value="female">
                                    Female
                                </label>
