...
@section("js")
    ...
    <script>
        $(document).ready(function () {
            ...
            var editbuttonclass = "{!! $settings['editbutton']??null !!}"
            var settingbuttonclass = "{!! $settings['settingbutton']??null !!}"
            var deletebuttonclass = "{!! $settings['deletebutton']??null !!}"
            ...
            var getitmeimage = function (datajosn) {
                ...
                if (img_extensions.hasOwnProperty(datajosn.extension)) {
                    ...
                    html = html.replace(/{url}/g, '/images/' + datajosn.extension + '.png');
                }
            ...
            $('[data-selectmenu="Uploader"]').change(function () {
                ...
                ajaxMedia('/api/api-media/get-media-uploaders-settings', {slug: getvalue}, htmlsdata)
            })
            ...
            $('[data-role="btnUploader"]').click(function () {
                ...
                ajaxMedia('/api/api-media/get-media-uploader-rendered', {folder_id: activefolderid}, afterajax)
            })
            ...
            function createnestd() {
                ...
                $('[data-media="folder"]').nestedSortable({
                    ...
                    relocate: function (event, ui) {
                        ...
                        postSendAjax('/api/api-media/get-sort-folder', jsondata, sortFolder)
                ...
                $('[data-folderid], a[data-dropnewitem]').droppable({
                    ...
                    drop: function (event, ui) {
                        ...
                        if (type == "folder") {
                            ...
                            postSendAjax('/api/api-media/get-sort-item', jsondata, itemmove);
                        }
            ...
            $('body').on('click', '[data-media="getitem"]', function (e) {
                ...
                if (getFoldername != '') {
                    ...
                    postSendAjax('/api/api-media/get-create-folder-child', jsondata, createnewfolder)
                ...
                postSendAjax('/api/api-media/get-folder-info', jsondata, settingFolder);
                /*bootbox.prompt("Rename "+editfodlername +" Folder", function(result){
                 if(result){
                    ...
                    buttons: {
                        confirm: {
                            ...
                            callback: function () {
                                ...
                                postSendAjax('/api/api-media/get-remove-folder', jsondata, deleteFolder);
