            ...
            <div class="product-content">
                <div class="product-title-more d-flex flex-wrap justify-content-between align-items-center">
                    <div class="product-title">
                        <h5 class="font-25 font-sec-bold text-uppercase m-0">{!! __('contact_us') !!}</h5>
                    </div>
                </div>
            </div>
            </a>
    ...
    <div class="single-product">
        <a href="{!! route('delivery') !!}" class="d-block">
            ...
            <div class="product-content">
                <div class="product-title-more d-flex flex-wrap justify-content-between align-items-center">
                    <div class="product-title">
                        <h5 class="font-25 font-sec-bold text-uppercase m-0">{!! __('delivery') !!}</h5>
                    </div>
                </div>
            </div>
        </a>
    ...
    <div class="single-product">
        <a href="{!! route('terms_conditions') !!}" class="d-block">
            ...
            <div class="product-content">
                <div class="product-title-more d-flex flex-wrap justify-content-between align-items-center">
                    <div class="product-title">
                        <h5 class="font-25 font-sec-bold text-uppercase m-0">{!! __('terms_and_conditions') !!}</h5>
                    </div>
                </div>
            </div>
        </a>
    ...
    <div class="single-product">
        <a href="{!! route('faq_page') !!}" class="d-block">
            ...
            <div class="product-content">
                <div class="product-title-more d-flex flex-wrap justify-content-between align-items-center">
                    <div class="product-title">
                        <h5 class="font-25 font-sec-bold text-uppercase m-0">{!! __('faq') !!}</h5>
                    </div>
                </div>
            </div>
        </a>
    ...
    <div class="single-product">
        <a href="{!! route('about_us') !!}" class="d-block">
            ...
            <div class="product-content">
                <div class="product-title-more d-flex flex-wrap justify-content-between align-items-center">
                    <div class="product-title">
                        <h5 class="font-25 font-sec-bold text-uppercase m-0">{!! __('about_us') !!}</h5>
                    </div>
                </div>
            </div>
        </a>
    ...
    <div class="single-product">
        <a href="{!! route('privacy') !!}" class="d-block">
            ...
            <div class="product-content">
                <div class="product-title-more d-flex flex-wrap justify-content-between align-items-center">
                    <div class="product-title">
                        <h5 class="font-25 font-sec-bold text-uppercase m-0">{!! __('privacy') !!}</h5>
                    </div>
                </div>
            </div>
        </a>
    ...
    <div class="single-product">
        <a href="{!! route('cookies') !!}" class="d-block">
            ...
            <div class="product-content">
                <div class="product-title-more d-flex flex-wrap justify-content-between align-items-center">
                    <div class="product-title">
                        <h5 class="font-25 font-sec-bold text-uppercase m-0">{!! __('cookies') !!}</h5>
                    </div>
                </div>
            </div>
        </a>
