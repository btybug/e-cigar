...
function filter_button($category, $text = 'Filter',$name=null,$is_multiple=true)
{
    enableFilter();
    global $_FILTER_HTML;
    ...
    return ($category)?view('filters.button', compact('category', 'text','name','is_multiple','uniqId')):'Shnorhavor Amanor Yev Surb &nund';
}
