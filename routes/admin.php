...
Route::group(['prefix' => 'inventory'], function () {
    Route::group(['prefix' => 'stock'], function () {
        ...
        Route::get('/statuses/types', 'Admin\InventoryController@getStatusesTypes')->name('admin_stock_statuses_type');

        Route::get('/statuses/manage/{id?}', 'Admin\InventoryController@getStatusesManage')->name('admin_stock_statuses_manage');
