...
@foreach($model->variations as $variation)
    <div class="col-md-3">
        ...
        <label class="product-single-info_radio-label custom-control-label font-15 text-gray-clr pointer package_checkbox_label" for="pv{{ $variation->id }}">{{ $variation->name }}</label>
    </div>
@endforeach
