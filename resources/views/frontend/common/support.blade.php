   ...
   <main class="main-content">
       <div class="container">
           <section class="qcbox_section">
               <div class="product-introduce mb-5">
                   <h1 class="mb-5 text-uppercase text-my-yellow mt-3">Support</h1>
                   <div class="row justify-content-center">
                       <div class="col-sm-3">
                           <a href="{!! route('faq_page') !!}"
                              class="text-center mb-4 px-5 py-4 d-flex flex-column d-block shadow-sm bg-white h-100 justify-content-center">
                            <span class="d-inline-block mb-3"><i class="fa fa-5x fa-file"
