                                                ...
                                                <div class="card-body panel-body">
                                                    <table class="form-table table">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                {!! Form::text('translatable['.strtolower($language->code).'][keywords]',get_translated($seo,strtolower($language->code),'keywords'),['class'=>'form-control','placeholder'=>getSeo($general,'og:keywords',$brand)]) !!}
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row" style="width: 16.5%">
                                                            ...
                                                            <td>
                                                                {!! Form::text('translatable['.strtolower($language->code).'][title]',get_translated($seo,strtolower($language->code),'title'),['class'=>'form-control','placeholder'=>getSeo($general,'og:title',$brand)]) !!}
                                                                <br>
                                                                <div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                {!! Form::textarea('translatable['.strtolower($language->code).'][description]',get_translated($seo,strtolower($language->code),'description'),['class'=>'form-control','rows'=>2,'placeholder'=>getSeo($general,'og:description',$brand)]) !!}
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                {!! Form::text('brand[translatable]['.strtolower($language->code).'][url]',get_translated($brand,strtolower($language->code),'url'),['class'=>'form-control']) !!}
                                                                <br>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-md-5 col-xs-12">
                                                    {!! Form::text('translatable['.strtolower($language->code).'][fb_title]',get_translated($seo,strtolower($language->code),'fb_title'),['class'=>'form-control','placeholder'=>getSeo($fbSeo,'og:title',$brand)]) !!}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-md-5 col-xs-12">
                                                    {!! Form::text('translatable['.strtolower($language->code).'][fb_description]',get_translated($seo,strtolower($language->code),'fb_description'),['class'=>'form-control','placeholder'=>getSeo($fbSeo,'og:description',$brand)]) !!}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-md-5 col-xs-12">
                                                    {!! Form::text('translatable['.strtolower($language->code).'][fb_image]',get_translated($seo,strtolower($language->code),'fb_image'),['class'=>'form-control','readonly','disabled','placeholder'=>getSeo($fbSeo,'og:image',$brand)]) !!}
                                    ...
                                    <div class="card-body panel-body">
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-md-5 col-xs-12">
                                                    {!! Form::text('translatable['.strtolower($language->code).'][twitter_title]',get_translated($seo,strtolower($language->code),'twitter_title'),['class'=>'form-control','placeholder'=>getSeo($twitterSeo,'og:description',$brand)]) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-md-5 col-xs-12">
                                                    {!! Form::text('translatable['.strtolower($language->code).'][twitter_description]',get_translated($seo,strtolower($language->code),'twitter_description'),['class'=>'form-control','placeholder'=>getSeo($twitterSeo,'og:description',$brand)]) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-md-5 col-xs-12">
                                                    {!! Form::text('translatable['.strtolower($language->code).'][twitter_image]',get_translated($seo,strtolower($language->code),'twitter_image'),['class'=>'form-control','placeholder'=>getSeo($twitterSeo,'og:image',$brand)]) !!}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
