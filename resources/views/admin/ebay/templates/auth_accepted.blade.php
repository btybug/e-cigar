...
<p><a class="btn btn-primary" href="/refresh-user-token?refresh-token={{$refreshToken|$url_encode}}" role="button">Use the above refresh token to generate a new token</a></p>
@else
