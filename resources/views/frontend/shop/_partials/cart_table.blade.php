        ...
        <div class="d-flex flex-wrap">
            <div class="col-lg-9 pl-md-left">
                <div class="left-content main-scrollbar w-100">
                    @if($geoZone)
                    <span class="head"><sup>*</sup>Your shopping cost based on <span class="font-main-bold">{{ $geoZone->name }}</span></span>
                    @endif
                                            ...
                                            <div class="shp-cart-product_right">
                                                ...
                                                <ul class="list-unstyled mb-0">
                                                    <li class="shp-cart-product_row shp-cart-product_prd-1 d-flex justify-content-between">
                                                        <p class="mb-0"><span>{{ $main->attributes->variation->name }}:</span>
                    ...
                    <div class="card order-summary">
                        ...
                        <div class="card-body border-top-0">
                            ...
                            <div class="checkout-btn text-center">
                                <a class="btn btn-primary text-uppercase font-15" href="{!! route('shop_check_out') !!}">
                                    CHECKOUT
                                </a>
                            </div>
                        </div>
