...
<div class="col-sm-{{ ($vSettings->price_per == 'product')? '10' : '12' }} products-list-wrap" id="products-list_{{ $vSettings->id }}" data-id="{{ $vSettings->id }}" data-limit="{{ $vSettings->count_limit }}">
