...
//        Route::post('/import-shop', 'Admin\App\AppController@importShop')->name('admin_app_import_shop');
    ...
    Route::group(['prefix' => 'barcode'], function () {
        ...
        Route::post('/print-barcode', 'Admin\BarcodesController@printBarcode')->name('admin_inventory_barcode_print');
    });
});
...
Route::group(['prefix' => 'stock'], function () {
    ...
    Route::get('/copy-stock/{id}', 'Admin\StockController@postStockCopy')->name('admin_stock_copy');
