    ...
    select_item: (elm, e) => {
      ...
      if (e.type === "dblclick") {
          if($(e.target).closest('.file').data('type') === 'html') {
            ...
            $("body").append(`<iframe src='https://view.officeapps.live.com/op/embed.aspx?src=${location.origin}${$(e.target).closest('.file').find('img').attr('src')}&amp;embedded=true" style="width:100%; height:500px" frameborder="0"></iframe>`)
