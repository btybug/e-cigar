...
@section('content')
    <div class="row " style="zoom: 75%">
        ...
        <div class="col-xs-12">
            <table id="users-actions" class="table table-style table-bordered" cellspacing="0" width="100%">
                <thead>
                <tr>
                    <th>#</th>
                    <th>Url</th>
...
@section('js')
    <script>
        $(function () {
            ...
            $('#users-actions').DataTable({
                ajax:  "{!! route('datatable_user_post_activity',$user->id) !!}",
                columns: [
                    {data: 'id',name: 'id'},
                    {data: 'url',name: 'url'},
                    {data: 'method', name: 'method'},
