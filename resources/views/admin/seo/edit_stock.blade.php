                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-md-5 col-xs-12">
                                                    {!! Form::text('translatable['.strtolower($language->code).'][fb_title]',get_translated($seo,strtolower($language->code),'fb_title'),['class'=>'form-control','placeholder'=>getSeo($fbSeo,'og:title',$stock)]) !!}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-md-5 col-xs-12">
                                                    {!! Form::text('translatable['.strtolower($language->code).'][fb_description]',get_translated($seo,strtolower($language->code),'fb_description'),['class'=>'form-control','placeholder'=>getSeo($fbSeo,'og:description',$stock)]) !!}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-md-5 col-xs-12">
                                                    {!! Form::text('translatable['.strtolower($language->code).'][fb_image]',get_translated($seo,strtolower($language->code),'fb_image'),['class'=>'form-control','readonly','disabled','placeholder'=>getSeo($fbSeo,'og:image',$stock)]) !!}
                                    ...
                                    <div class="card-body panel-body">
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-md-5 col-xs-12">
                                                    {!! Form::text('translatable['.strtolower($language->code).'][twitter_title]',get_translated($seo,strtolower($language->code),'twitter_title'),['class'=>'form-control','placeholder'=>getSeo($twitterSeo,'og:description',$stock)]) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-md-5 col-xs-12">
                                                    {!! Form::text('translatable['.strtolower($language->code).'][twitter_description]',get_translated($seo,strtolower($language->code),'twitter_description'),['class'=>'form-control','placeholder'=>getSeo($twitterSeo,'og:description',$stock)]) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-md-5 col-xs-12">
                                                    {!! Form::text('translatable['.strtolower($language->code).'][twitter_image]',get_translated($seo,strtolower($language->code),'twitter_image'),['class'=>'form-control','placeholder'=>getSeo($twitterSeo,'og:image',$stock)]) !!}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
