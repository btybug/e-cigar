                        ...
                        <div class="nav-item--has-dropdown_dropdown">
                            ...
                            <div class="all-filters row">
                                <div class="col-lg-5 col-md-12 filter-left-col">
                                    <div class="filter-wall cat-filter">
                                        <h5 class="font-sec-bold font-16 text-uppercase">CATEGORY NAME</h5>
                                        <div class="form-group row select_with-tag-wrapper position-relative">

                                            <label for="deliverySelect1"
                                                   class="text-main-clr mb-0 col-sm-4 col-form-label text-right text-uppercase">Guaranteed
                                                Delivery</label>
                                            <div class="simple_select_wrapper col-sm-8 p-sm-0">
                                                <select id="deliverySelect1"
                                                        class="select-2 select-2--no-search main-select main-select-2arrows not-selected arrow-dark">
                                                    <option class="selected">No Preference</option>
                                                    <option>1</option>
                                                    <option>2</option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group row select_with-tag-wrapper position-relative">
                                            ...
                                            <label for="fieldTitle"
                                                   class="text-main-clr mb-0 col-sm-4 col-form-label text-right text-uppercase">FIELD
                                                TITLE</label>
                                            <div class="field-title_select col-sm-8 p-sm-0 position-relative">
                                                <select id="fieldTitle"
                                                        class="select-2 main-select main-select-2arrows products-filter-wrap_select not-selected select_with-tag"
                                                        multiple="multiple">
                                        ...
                                        <div class="form-group row border-bottom ml-0"></div>
                                        <div class="form-group row select_with-tag-wrapper position-relative">

                                            <label for="deliverySelect2"
                                                   class="text-main-clr mb-0 col-sm-4 col-form-label text-right text-uppercase">Guaranteed
                                                Delivery</label>
                                            <div class="simple_select_wrapper col-sm-8 p-sm-0">
                                                <select id="deliverySelect2"
                                                        class="select-2 select-2--no-search main-select main-select-2arrows not-selected arrow-dark">
                                                    <option class="selected">No Preference</option>
                                                    <option>1</option>
                                                    <option>2</option>
                                ...
                                <div class="col-lg-3 col-md-6">
                                    <div class="filter-wall colors">
                                        <h5 class="font-sec-bold font-16 text-uppercase">COLOR</h5>
                                        <div class="d-flex flex-wrap">
                                            <div class="col-sm-3 single-wall">
                                                <div class="custom-control custom-radio custom-control-inline cl-white">
                                                    <input type="radio" class="custom-control-input" name="colors"
                                                           id="customRadio4">
                                                    <label class="custom-control-label pointer"
                                                           for="customRadio4">White</label>
                                                </div>
                                            </div>
                                            <div class="col-sm-3 single-wall">
                                                <div class="custom-control custom-radio custom-control-inline cl-blue">
                                                    <input type="radio" class="custom-control-input" checked="checked"
                                                           name="colors" id="customRadio1">
                                                    <label class="custom-control-label pointer"
                                                           for="customRadio1">Blue</label>
                                                </div>
                                            </div>
                                            <div class="col-sm-3 single-wall">
                                                <div class="custom-control custom-radio custom-control-inline cl-red">
                                                    <input type="radio" class="custom-control-input" name="colors"
                                                           id="customRadio6">
                                                    <label class="custom-control-label pointer"
                                                           for="customRadio6">Red</label>
                                                </div>
                                            </div>
                                            <div class="col-sm-3 single-wall">
                                                <div class="custom-control custom-radio custom-control-inline cl-purple">
                                                    <input type="radio" class="custom-control-input" name="colors"
                                                           id="customRadio7">
                                                    <label class="custom-control-label pointer" for="customRadio7">Purple</label>
                                                </div>
                                            </div>
                                            <div class="col-sm-3 single-wall">
                                                <div class="custom-control custom-radio custom-control-inline cl-black">
                                                    <input type="radio" class="custom-control-input" name="colors"
                                                           id="customRadio5">
                                                    <label class="custom-control-label pointer"
                                                           for="customRadio5">Black</label>
                                                </div>
                                            </div>
                                            <div class="col-sm-3 single-wall">
                                                <div class="custom-control custom-radio custom-control-inline cl-green">
                                                    <input type="radio" class="custom-control-input" name="colors"
                                                           id="customRadio3">
                                                    <label class="custom-control-label pointer"
                                                           for="customRadio3">Green</label>
                                                </div>
                                            </div>
                                            <div class="col-sm-3 single-wall">
                                                <div class="custom-control custom-radio custom-control-inline cl-pink">
                                                    <input type="radio" class="custom-control-input" name="colors"
                                                           id="customRadio10">
                                                    <label class="custom-control-label pointer"
                                                           for="customRadio10">Pink</label>
                                                </div>
                                            </div>
                                            <div class="col-sm-3 single-wall">
                                                <div class="custom-control custom-radio custom-control-inline cl-yellow">
                                                    <input type="radio" class="custom-control-input" name="colors"
                                                           id="customRadio8">
                                                    <label class="custom-control-label pointer" for="customRadio8">Yellow</label>
                                                </div>
                                            </div>
                                            <div class="col-sm-3 single-wall">
                                                <div class="custom-control custom-radio custom-control-inline cl-gray">
                                                    <input type="radio" class="custom-control-input" name="colors"
                                                           id="customRadio9">
                                                    <label class="custom-control-label pointer"
                                                           for="customRadio9">Gray</label>
                                                </div>
                                            </div>

                                            <div class="col-sm-3 single-wall">
                                                <div class="custom-control custom-radio custom-control-inline cl-dark-gray">
                                                    <input type="radio" class="custom-control-input" name="colors"
                                                           id="customRadio11">
                                                    <label class="custom-control-label pointer" for="customRadio11">Dark
                                                        Gray</label>
                                                </div>
                                            </div>
                                            <div class="col-sm-3 single-wall">
                                                <div class="custom-control custom-radio custom-control-inline cl-dark-green">
                                                    <input type="radio" class="custom-control-input" name="colors"
                                                           id="customRadio12">
                                                    <label class="custom-control-label pointer" for="customRadio12">D.
                                                        Green</label>
                                                </div>
                                            </div>
                                            <div class="col-sm-3 single-wall">
                                                <div class="custom-control custom-radio custom-control-inline cl-orange">
                                                    <input type="radio" class="custom-control-input" name="colors"
                                                           id="customRadio13">
                                                    <label class="custom-control-label pointer" for="customRadio13">Orange</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="single-wrap">
                                            <div class="custom-control custom-checkbox custom-control-inline align-items-center">
                                                ...
                                                <label class="custom-control-label text-gray-clr font-15"
                                                       for="customCheck1">DaVinci <span
                                                            class="amount">(189)</span></label>
                                            </div>
                                        </div>
                                        <div class="single-wrap">
                                            <div class="custom-control custom-checkbox custom-control-inline align-items-center">
                                                <input type="checkbox" class="custom-control-input" id="customCheck2"
                                                       checked="checked" name="example2">
                                                <label class="custom-control-label text-gray-clr font-15"
                                                       for="customCheck2">Dr. Dabber <span
                                                            class="amount">(25)</span></label>
                                            </div>
                                        </div>
                                        <div class="single-wrap">
                                            <div class="custom-control custom-checkbox custom-control-inline align-items-center">
                                                <input type="checkbox" class="custom-control-input" id="customCheck3"
                                                       name="example3">
                                                <label class="custom-control-label text-gray-clr font-15"
                                                       for="customCheck3">Eleaf <span class="amount">(9)</span></label>
                                            </div>
                                        </div>
                                        <div class="single-wrap">
                                            <div class="custom-control custom-checkbox custom-control-inline align-items-center">
                                                <input type="checkbox" class="custom-control-input" id="customCheck4"
                                                       name="example4">
                                                <label class="custom-control-label text-gray-clr font-15"
                                                       for="customCheck4">SMOK <span class="amount">(70)</span></label>
                                            </div>
                                        </div>
                                        <div class="single-wrap">
                                            <div class="custom-control custom-checkbox custom-control-inline align-items-center">
                                                <input type="checkbox" class="custom-control-input" id="customCheck5"
                                                       name="example5">
                                                <label class="custom-control-label text-gray-clr font-15"
                                                       for="customCheck5">Unbranded <span
                                                            class="amount">(3)</span></label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="product-card position-relative">
                                ...
                                <div class="product-card_body">
                                    ...
                                    <div class="product-card_body-text">
                                        <h2 class="card-title font-21 font-sec-bold">Click-N-Vape Smoke V8 Starter</h2>
...
<path fill-rule="evenodd" fill="rgb(124, 124, 124)"
      d="M19.794,5.420 C19.690,5.514 19.554,5.566 19.412,5.566 C19.255,5.566 19.109,5.505 19.002,5.394 C16.700,3.007 13.586,1.693 10.231,1.693 C6.876,1.693 3.761,3.007 1.461,5.394 C1.354,5.505 1.208,5.566 1.050,5.566 C0.908,5.566 0.773,5.514 0.668,5.420 C0.442,5.217 0.429,4.873 0.641,4.654 C3.156,2.045 6.562,0.609 10.231,0.608 C13.901,0.609 17.307,2.045 19.822,4.654 C20.033,4.873 20.020,5.217 19.794,5.420 ZM10.231,4.473 C12.727,4.472 15.121,5.464 16.970,7.266 C17.076,7.368 17.133,7.505 17.133,7.649 C17.132,7.794 17.073,7.930 16.967,8.032 C16.861,8.133 16.721,8.189 16.572,8.189 C16.421,8.189 16.280,8.132 16.174,8.029 C14.537,6.435 12.427,5.557 10.232,5.557 C8.035,5.557 5.925,6.435 4.288,8.029 C4.183,8.132 4.041,8.189 3.890,8.189 C3.741,8.189 3.601,8.133 3.495,8.032 C3.276,7.821 3.274,7.477 3.492,7.265 C5.341,5.465 7.734,4.473 10.231,4.473 ZM10.166,8.371 L10.223,8.371 C11.492,8.371 12.884,8.950 13.858,9.882 C13.964,9.984 14.023,10.120 14.024,10.264 C14.024,10.409 13.966,10.546 13.861,10.649 C13.755,10.752 13.614,10.809 13.463,10.809 C13.314,10.809 13.173,10.753 13.068,10.652 C12.309,9.925 11.192,9.455 10.224,9.455 L10.167,9.455 C9.198,9.455 8.081,9.925 7.322,10.652 C7.217,10.753 7.076,10.809 6.927,10.809 C6.777,10.809 6.635,10.752 6.529,10.649 C6.311,10.436 6.313,10.092 6.533,9.882 C7.506,8.950 8.898,8.371 10.166,8.371 ZM10.192,12.459 C10.780,12.459 11.259,12.922 11.259,13.490 C11.259,14.059 10.780,14.521 10.192,14.521 C9.604,14.521 9.126,14.059 9.126,13.490 C9.126,12.922 9.604,12.459 10.192,12.459 Z"/>
                                            ...
                                            <!--Price-->
                                            <span class="product-card_price d-inline-block font-sec-bold font-24 text-tert-clr lh-1 ml-auto">$24</span>
                                        </div>
                                    </div>
                                    <!--btn-->
                                    <a href="#"
                        ...
                        <div class="products-wrap_col">
                            <div class="product-card position-relative">
                                ...
                                <div class="product-card_body">
                                    ...
                                    <div class="product-card_body-text">
                                        <h2 class="card-title font-21 font-sec-bold">60W SMOK² PRIV V8 Starter1</h2>
                                        <p class="card-text font-main-light font-15 text-light-clr">Lorem ipsum dolor
                                            amet, consectetur
                                            adipiscing elit. Morbi sodales </p>
                                        <div class="product-card_icons-outer d-flex justify-content-between align-items-center">
                        ...
                        <div class="products-wrap_col">
                            <div class="product-card position-relative">
                                ...
                                <div class="product-card_body">
                                    ...
                                    <div class="product-card_body-text">
                                        <h2 class="card-title font-21 font-sec-bold">Stick V8 Starter Kit W/ TFV8</h2>
                                        <p class="card-text font-main-light font-15 text-light-clr">Lorem ipsum dolor
                                            amet, consectetur
                                            adipiscing elit. Morbi sodales </p>
                                        <div class="product-card_icons-outer d-flex justify-content-between align-items-center">
                                ...
                                <div class="product-card_body">
                                    ...
                                    <div class="product-card_body-text">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            <!--Price-->
                                            <span class="product-card_price d-inline-block font-sec-bold font-24 text-tert-clr lh-1 ml-auto">$70</span>
                                        </div>
                                    </div>
                                    <!--btn-->
                                    <a href="#"
                        ...
                        <div class="products-wrap_col">
                            <div class="product-card position-relative">
                                ...
                                <svg viewBox="0 0 20 18" width="20px" height="18px">
                                    ...
                                    <!--Sale label-->
                                    <span class="sale-label product-card_sale-label d-inline-block text-uppercase font-main-bold font-16 text-sec-clr position-absolute">-20%</span>
                                </div>
                                <div class="product-card_body">
                                    <!--product image thumbs-->
                                    <div class="d-flex product-card-thumbs">
                                    ...
                                    <div class="product-card_body-text">
                                        <h2 class="card-title font-21 font-sec-bold">Micro ONE Kit Vape E-Cig Mod</h2>
                                        <p class="card-text font-main-light font-15 text-light-clr">Lorem ipsum dolor
                                            amet, consectetur
                                            adipiscing elit. Morbi sodales </p>
                                        <div class="product-card_icons-outer d-flex justify-content-between align-items-center">
...
<path fill-rule="evenodd" fill="rgb(124, 124, 124)"
      d="M19.794,5.420 C19.690,5.514 19.554,5.566 19.412,5.566 C19.255,5.566 19.109,5.505 19.002,5.394 C16.700,3.007 13.586,1.693 10.231,1.693 C6.876,1.693 3.761,3.007 1.461,5.394 C1.354,5.505 1.208,5.566 1.050,5.566 C0.908,5.566 0.773,5.514 0.668,5.420 C0.442,5.217 0.429,4.873 0.641,4.654 C3.156,2.045 6.562,0.609 10.231,0.608 C13.901,0.609 17.307,2.045 19.822,4.654 C20.033,4.873 20.020,5.217 19.794,5.420 ZM10.231,4.473 C12.727,4.472 15.121,5.464 16.970,7.266 C17.076,7.368 17.133,7.505 17.133,7.649 C17.132,7.794 17.073,7.930 16.967,8.032 C16.861,8.133 16.721,8.189 16.572,8.189 C16.421,8.189 16.280,8.132 16.174,8.029 C14.537,6.435 12.427,5.557 10.232,5.557 C8.035,5.557 5.925,6.435 4.288,8.029 C4.183,8.132 4.041,8.189 3.890,8.189 C3.741,8.189 3.601,8.133 3.495,8.032 C3.276,7.821 3.274,7.477 3.492,7.265 C5.341,5.465 7.734,4.473 10.231,4.473 ZM10.166,8.371 L10.223,8.371 C11.492,8.371 12.884,8.950 13.858,9.882 C13.964,9.984 14.023,10.120 14.024,10.264 C14.024,10.409 13.966,10.546 13.861,10.649 C13.755,10.752 13.614,10.809 13.463,10.809 C13.314,10.809 13.173,10.753 13.068,10.652 C12.309,9.925 11.192,9.455 10.224,9.455 L10.167,9.455 C9.198,9.455 8.081,9.925 7.322,10.652 C7.217,10.753 7.076,10.809 6.927,10.809 C6.777,10.809 6.635,10.752 6.529,10.649 C6.311,10.436 6.313,10.092 6.533,9.882 C7.506,8.950 8.898,8.371 10.166,8.371 ZM10.192,12.459 C10.780,12.459 11.259,12.922 11.259,13.490 C11.259,14.059 10.780,14.521 10.192,14.521 C9.604,14.521 9.126,14.059 9.126,13.490 C9.126,12.922 9.604,12.459 10.192,12.459 Z"/>
                                            ...
                                            $100
                                                <!--old price-->
                                            <span class="product-card_old-price font-sec-reg font-18 text-gray-clr lh-1 position-absolute">$120</span>
                                        </span>
                                        </div>
                                    </div>
                                    <!--btn-->
                        ...
                        <div class="products-wrap_col">
                            <div class="product-card position-relative">
                                ...
                                <div class="product-card_body">
                                    ...
                                    <div class="product-card_body-text">
                                        <h2 class="card-title font-21 font-sec-bold">Vaping BO One Ultra Portable</h2>
                                        <p class="card-text font-main-light font-15 text-light-clr">Lorem ipsum dolor
                                            amet, consectetur
                                            adipiscing elit. Morbi sodales </p>
                                        <div class="product-card_icons-outer d-flex justify-content-between align-items-center">
...
<path fill-rule="evenodd" fill="rgb(124, 124, 124)"
      d="M19.794,5.420 C19.690,5.514 19.554,5.566 19.412,5.566 C19.255,5.566 19.109,5.505 19.002,5.394 C16.700,3.007 13.586,1.693 10.231,1.693 C6.876,1.693 3.761,3.007 1.461,5.394 C1.354,5.505 1.208,5.566 1.050,5.566 C0.908,5.566 0.773,5.514 0.668,5.420 C0.442,5.217 0.429,4.873 0.641,4.654 C3.156,2.045 6.562,0.609 10.231,0.608 C13.901,0.609 17.307,2.045 19.822,4.654 C20.033,4.873 20.020,5.217 19.794,5.420 ZM10.231,4.473 C12.727,4.472 15.121,5.464 16.970,7.266 C17.076,7.368 17.133,7.505 17.133,7.649 C17.132,7.794 17.073,7.930 16.967,8.032 C16.861,8.133 16.721,8.189 16.572,8.189 C16.421,8.189 16.280,8.132 16.174,8.029 C14.537,6.435 12.427,5.557 10.232,5.557 C8.035,5.557 5.925,6.435 4.288,8.029 C4.183,8.132 4.041,8.189 3.890,8.189 C3.741,8.189 3.601,8.133 3.495,8.032 C3.276,7.821 3.274,7.477 3.492,7.265 C5.341,5.465 7.734,4.473 10.231,4.473 ZM10.166,8.371 L10.223,8.371 C11.492,8.371 12.884,8.950 13.858,9.882 C13.964,9.984 14.023,10.120 14.024,10.264 C14.024,10.409 13.966,10.546 13.861,10.649 C13.755,10.752 13.614,10.809 13.463,10.809 C13.314,10.809 13.173,10.753 13.068,10.652 C12.309,9.925 11.192,9.455 10.224,9.455 L10.167,9.455 C9.198,9.455 8.081,9.925 7.322,10.652 C7.217,10.753 7.076,10.809 6.927,10.809 C6.777,10.809 6.635,10.752 6.529,10.649 C6.311,10.436 6.313,10.092 6.533,9.882 C7.506,8.950 8.898,8.371 10.166,8.371 ZM10.192,12.459 C10.780,12.459 11.259,12.922 11.259,13.490 C11.259,14.059 10.780,14.521 10.192,14.521 C9.604,14.521 9.126,14.059 9.126,13.490 C9.126,12.922 9.604,12.459 10.192,12.459 Z"/>
                                            ...
                                            <!--Price-->
                                            <span class="product-card_price d-inline-block font-sec-bold font-24 text-tert-clr lh-1 ml-auto">$62</span>
                                        </div>
                                    </div>
                                    <a href="#"
                                       class="product-card_btn d-inline-flex align-items-center text-center font-15 text-sec-clr text-uppercase">
                        ...
                        <div class="products-wrap_col">
                            <div class="product-card position-relative">
                                ...
                                <svg viewBox="0 0 20 18" width="20px" height="18px">
                                    ...
                                    <!--sale label-->
                                    <span class="sale-label product-card_sale-label d-inline-block text-uppercase font-main-bold font-16 text-sec-clr position-absolute">-15%</span>
                                </div>
                                <div class="product-card_body">
                                    <!--product image thumbs-->
                                    <div class="d-flex product-card-thumbs">
                                    ...
                                    <div class="product-card_body-text">
                                        <h2 class="card-title font-21 font-sec-bold">Smok Pen 22 and 30ml of Juice</h2>
                                        <p class="card-text font-main-light font-15 text-light-clr">Lorem ipsum dolor
                                            amet, consectetur
                                            adipiscing elit. Morbi sodales </p>
                                        <div class="product-card_icons-outer d-flex justify-content-between align-items-center">
...
<path fill-rule="evenodd" fill="rgb(124, 124, 124)"
      d="M16.000,4.548 C16.000,4.315 15.877,4.111 15.686,4.009 L8.258,0.062 C8.081,-0.025 7.875,-0.025 7.711,0.092 C7.547,0.194 7.452,0.397 7.452,0.601 L7.452,7.534 L0.845,4.009 C0.571,3.863 0.229,3.980 0.093,4.271 C-0.044,4.563 0.065,4.927 0.339,5.072 L6.753,8.480 L0.339,11.917 C0.065,12.063 -0.058,12.427 0.093,12.718 C0.188,12.922 0.393,13.053 0.599,13.053 C0.681,13.053 0.763,13.039 0.845,12.995 L7.452,9.471 L7.452,16.403 C7.452,16.607 7.547,16.796 7.711,16.912 C7.807,16.971 7.903,17.000 8.012,17.000 C8.094,17.000 8.190,16.985 8.258,16.942 L15.686,12.995 C15.877,12.893 16.000,12.689 16.000,12.456 C16.000,12.223 15.877,12.019 15.686,11.917 L9.270,8.495 L15.686,5.087 C15.877,4.985 16.000,4.781 16.000,4.548 ZM8.573,15.427 L8.573,9.471 L14.181,12.456 L8.573,15.427 ZM8.573,7.534 L8.573,1.562 L14.181,4.548 L8.573,7.534 Z"/>
                                            ...
                                            $77.5
                                                <!--old price-->
                                            <span class="product-card_old-price font-sec-reg font-18 text-gray-clr lh-1 position-absolute">$90</span>
                                        </span>
                                        </div>
                                    </div>
                                    <!--btn-->
